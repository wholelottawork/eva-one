    ...
    <div className="space-y-4">
              ...
              style={{
                ...
                color:
                  selectedPeriod === period.key
                    ? 'var(--accent-primary)'
                    : 'var(--text-secondary)',
                border: `1px solid ${selectedPeriod === period.key ? 'var(--accent-primary-border-strong)' : 'var(--surface-tertiary)'}`,
              }}
            >
              ...
              style={{
                background:
                  idx === 0
                    ? 'var(--accent-primary-bg)'
                    : 'rgba(43, 49, 57, 0.5)',
                border: `1px solid ${idx === 0 ? 'var(--accent-primary-border)' : 'var(--surface-tertiary)'}`,
              }}
            >
              <div
      ...
      >
        ...
        <ResponsiveContainer width="100%" height={420}>
          ...
          >
            ...
            <CartesianGrid
              strokeDasharray="3 3"
              stroke={getCssVar('--surface-secondary')}
              vertical={false}
            />

            <XAxis
              dataKey="time"
              stroke={getCssVar('--surface-tertiary')}
              tick={{ fill: getCssVar('--text-tertiary'), fontSize: 10 }}
              tickLine={false}
              axisLine={{ stroke: getCssVar('--surface-tertiary') }}
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        >
          ...
          <div className="text-sm font-bold mono" style={{ color: '#4ade80' }}>
            {gap}%
          </div>
        </div>
        <div
